...
export default function HistorialPlaceholder() {
  return (
    <div className="flex flex-col items-center justify-center h-[60vh]">
      ...
      <p className="text-slate-500 mt-2">El historial de reparaciones estará disponible en la próxima actualización.</p>
    </div>
  );
}
